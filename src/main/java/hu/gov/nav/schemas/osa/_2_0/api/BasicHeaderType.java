 ...
 *       &lt;sequence>
 *         &lt;element name="requestId" type="{http://schemas.nav.gov.hu/OSA/2.0/api}EntityIdType"/>
 *         &lt;element name="timestamp" type="{http://schemas.nav.gov.hu/OSA/2.0/data}TimestampType"/>
 *         &lt;element name="requestVersion" type="{http://schemas.nav.gov.hu/OSA/2.0/api}RequestVersionType"/>
 *         &lt;element name="headerVersion" type="{http://schemas.nav.gov.hu/OSA/2.0/api}HeaderVersionType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class BasicHeaderType {
    ...
    @XmlElement(required = true, defaultValue = "2.0")
