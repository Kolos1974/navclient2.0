 ...
 *       &lt;sequence>
 *         &lt;element name="login" type="{http://schemas.nav.gov.hu/OSA/2.0/api}LoginType"/>
 *         &lt;element name="passwordHash" type="{http://schemas.nav.gov.hu/OSA/2.0/api}Sha512HashType"/>
 *         &lt;element name="taxNumber" type="{http://schemas.nav.gov.hu/OSA/2.0/data}TaxpayerIdType"/>
 *         &lt;element name="requestSignature" type="{http://schemas.nav.gov.hu/OSA/2.0/api}Sha512HashType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
