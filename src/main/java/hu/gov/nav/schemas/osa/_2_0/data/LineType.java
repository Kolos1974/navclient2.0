 ...
 *       &lt;sequence>
 *         &lt;element name="lineNumber" type="{http://schemas.nav.gov.hu/OSA/2.0/data}LineNumberType"/>
 *         &lt;element name="lineModificationReference" type="{http://schemas.nav.gov.hu/OSA/2.0/data}LineModificationReferenceType" minOccurs="0"/>
 *         &lt;element name="referencesToOtherLines" type="{http://schemas.nav.gov.hu/OSA/2.0/data}ReferencesToOtherLinesType" minOccurs="0"/>
 *         &lt;element name="advanceIndicator" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="productCodes" type="{http://schemas.nav.gov.hu/OSA/2.0/data}ProductCodesType" minOccurs="0"/>
 *         &lt;element name="lineExpressionIndicator" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *         &lt;element name="lineNatureIndicator" type="{http://schemas.nav.gov.hu/OSA/2.0/data}LineNatureIndicatorType" minOccurs="0"/>
 *         &lt;element name="lineDescription" type="{http://schemas.nav.gov.hu/OSA/2.0/data}SimpleText512NotBlankType" minOccurs="0"/>
 *         &lt;element name="quantity" type="{http://schemas.nav.gov.hu/OSA/2.0/data}QuantityType" minOccurs="0"/>
 *         &lt;element name="unitOfMeasure" type="{http://schemas.nav.gov.hu/OSA/2.0/data}UnitOfMeasureType" minOccurs="0"/>
 *         &lt;element name="unitOfMeasureOwn" type="{http://schemas.nav.gov.hu/OSA/2.0/data}SimpleText50NotBlankType" minOccurs="0"/>
 *         &lt;element name="unitPrice" type="{http://schemas.nav.gov.hu/OSA/2.0/data}QuantityType" minOccurs="0"/>
 *         &lt;element name="unitPriceHUF" type="{http://schemas.nav.gov.hu/OSA/2.0/data}QuantityType" minOccurs="0"/>
 *         &lt;element name="lineDiscountData" type="{http://schemas.nav.gov.hu/OSA/2.0/data}DiscountDataType" minOccurs="0"/>
 *         &lt;choice>
 *           &lt;element name="lineAmountsNormal" type="{http://schemas.nav.gov.hu/OSA/2.0/data}LineAmountsNormalType" minOccurs="0"/>
 *           &lt;element name="lineAmountsSimplified" type="{http://schemas.nav.gov.hu/OSA/2.0/data}LineAmountsSimplifiedType" minOccurs="0"/>
 *         &lt;/choice>
 *         &lt;element name="intermediatedService" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="aggregateInvoiceLineData" type="{http://schemas.nav.gov.hu/OSA/2.0/data}AggregateInvoiceLineDataType" minOccurs="0"/>
 *         &lt;element name="newTransportMean" type="{http://schemas.nav.gov.hu/OSA/2.0/data}NewTransportMeanType" minOccurs="0"/>
 *         &lt;element name="depositIndicator" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="marginSchemeIndicator" type="{http://schemas.nav.gov.hu/OSA/2.0/data}MarginSchemeType" minOccurs="0"/>
 *         &lt;element name="ekaerIds" type="{http://schemas.nav.gov.hu/OSA/2.0/data}EkaerIdsType" minOccurs="0"/>
 *         &lt;element name="obligatedForProductFee" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="GPCExcise" type="{http://schemas.nav.gov.hu/OSA/2.0/data}MonetaryType" minOccurs="0"/>
 *         &lt;element name="dieselOilPurchase" type="{http://schemas.nav.gov.hu/OSA/2.0/data}DieselOilPurchaseType" minOccurs="0"/>
 *         &lt;element name="netaDeclaration" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="productFeeClause" type="{http://schemas.nav.gov.hu/OSA/2.0/data}ProductFeeClauseType" minOccurs="0"/>
 *         &lt;element name="lineProductFeeContent" type="{http://schemas.nav.gov.hu/OSA/2.0/data}ProductFeeDataType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="additionalLineData" type="{http://schemas.nav.gov.hu/OSA/2.0/data}AdditionalDataType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
