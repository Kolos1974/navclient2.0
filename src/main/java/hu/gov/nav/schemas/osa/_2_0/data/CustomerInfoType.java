 ...
 *       &lt;sequence>
 *         &lt;element name="customerTaxNumber" type="{http://schemas.nav.gov.hu/OSA/2.0/data}TaxNumberType" minOccurs="0"/>
 *         &lt;element name="groupMemberTaxNumber" type="{http://schemas.nav.gov.hu/OSA/2.0/data}TaxNumberType" minOccurs="0"/>
 *         &lt;element name="communityVatNumber" type="{http://schemas.nav.gov.hu/OSA/2.0/data}CommunityVatNumberType" minOccurs="0"/>
 *         &lt;element name="thirdStateTaxId" type="{http://schemas.nav.gov.hu/OSA/2.0/data}SimpleText50NotBlankType" minOccurs="0"/>
 *         &lt;element name="customerName" type="{http://schemas.nav.gov.hu/OSA/2.0/data}SimpleText512NotBlankType"/>
 *         &lt;element name="customerAddress" type="{http://schemas.nav.gov.hu/OSA/2.0/data}AddressType"/>
 *         &lt;element name="customerBankAccountNumber" type="{http://schemas.nav.gov.hu/OSA/2.0/data}BankAccountNumberType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
