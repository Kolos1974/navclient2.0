 ...
 *       &lt;sequence>
 *         &lt;element name="header" type="{http://schemas.nav.gov.hu/OSA/2.0/api}BasicHeaderType"/>
 *         &lt;element name="result" type="{http://schemas.nav.gov.hu/OSA/2.0/api}BasicResultType"/>
 *         &lt;element name="software" type="{http://schemas.nav.gov.hu/OSA/2.0/api}SoftwareType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    ...
    QueryServiceMetricsResponseType.class,
    QueryInvoiceDataResponseType.class,
    QueryTaxpayerResponseType.class,
    QueryInvoiceCheckResponseType.class,
    QueryInvoiceDigestResponseType.class,
    TransactionResponseType.class,
    TokenExchangeResponseType.class,
    QueryTransactionStatusResponseType.class
})
