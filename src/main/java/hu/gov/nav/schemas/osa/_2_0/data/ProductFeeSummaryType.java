 ...
 *       &lt;sequence>
 *         &lt;element name="productFeeOperation" type="{http://schemas.nav.gov.hu/OSA/2.0/data}ProductFeeOperationType"/>
 *         &lt;element name="productFeeData" type="{http://schemas.nav.gov.hu/OSA/2.0/data}ProductFeeDataType" maxOccurs="unbounded"/>
 *         &lt;element name="productChargeSum" type="{http://schemas.nav.gov.hu/OSA/2.0/data}MonetaryType"/>
 *         &lt;element name="paymentEvidenceDocumentData" type="{http://schemas.nav.gov.hu/OSA/2.0/data}PaymentEvidenceDocumentDataType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
